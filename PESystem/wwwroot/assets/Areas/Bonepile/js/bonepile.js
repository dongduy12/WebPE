document.addEventListener("DOMContentLoaded", async function () {
    ...
    // ✅ Xuất ra global scope để Layout gọi được
    ...
    window.addEventListener("resize", () => {
        ...
        resizeTimeout = setTimeout(resizeAllCharts, 100);
    });
    ...
    function createStatusBarChart(statusCounts) {
        ...
        statusChart = echarts.init(chartDom); // gán vào biến toàn cục
    ...
    function createAgingPieChart(agingDataList) {
        ...
        // Màu neon sáng rõ
        const colorMap = {
            "<45": "#22D3EE",   // xanh cyan sáng
            "45-89": "#FACC15", // vàng tươi
            ">=90": "#F87171"    // đỏ sáng
        };
        ...
        agingChart = echarts.init(chartDom); // gán biến toàn cục
        ...
        // Giữ click event (nếu cần mở bảng)
